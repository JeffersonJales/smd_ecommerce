 ...
 * @author jeffe
 */
public class AcessarPaginaSessao extends HttpServlet {

    @Override
    protected void service(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        
        if(!Config.isSessionValid(request)){
            Config.redirectUser(request, response, "login.jsp","Login necessário para continuar");
        }
        else{
